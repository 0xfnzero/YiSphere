...
结合传统术数（易经、八字、六爻、黄历）与 AI 的对话式预测与择日应用。用户用自然语言提问，选择不同「大师」角色对话，AI 结合程序自动计算的八字/黄历/卦象进行解读，支持多轮追问与按角色保存聊天记录。

## 功能概览

- **多角色对话**：左侧可选多位「大师」（神算子、文渊先生、子平先生、易翁老人、周文王、诸葛亮、李淳风、袁天罡等），每位有擅长领域与古人语气，右侧为与当前角色的聊天窗口。
...
| 奇门/风水/紫微/梅花/大六壬/太乙/测字/相术/解梦 | 由对应角色做简要解答 |
...
- 左侧点击一位大师（如「周文王」「神算子」），右侧输入自然语言，例如：
  - 「农历生日 1988.3.24 13:30 男 泉州，帮我占卜一卦 运势」
